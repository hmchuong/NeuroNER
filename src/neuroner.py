...
class NeuroNER(object):
    ...
    def _get_valid_dataset_filepaths(self, parameters, dataset_types=['train', 'valid', 'test', 'deploy']):
        '''
        Tìm trong data_set_text_folder các file
        Tham số:
        ...
        (
            {   // dataset_filepaths các fields bên dưới là optional, không nhất thiết phải đủ 4
                "train": "data_text_folder/train.txt",
                "valid": "data_text_folder/valid.txt",
                "test": "data_text_folder/test.txt",
                "deploy": "data_text_folder/deploy.txt"
            },
